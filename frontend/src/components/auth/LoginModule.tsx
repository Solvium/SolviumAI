...
import TelegramButtonSvg from "@/app/assets/userProfile/Button.svg";
  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <Image
          src="/assets/background/start-screen.png"
          alt="Background"
          fill
        ...
        <div className="flex flex-col items-center justify-center px-8 text-center">
          ...
          <div className="space-y-4 w-full max-w-sm">
            ...
            {/* <button
                ...
                className="w-full flex items-center justify-center gap-3 bg-blue-500/90 hover:bg-blue-600/90 disabled:bg-blue-400/90 text-white font-bold py-2 px-6 rounded-full transition-all duration-200 transform hover:scale-105 shadow-2xl border-2 border-white/20 backdrop-blur-sm"
              >
