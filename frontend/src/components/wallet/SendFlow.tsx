...
const SendFlow = ({ onClose, onSuccess }: SendFlowProps) => {
  ...
  const contacts = [
    { name: "Bessie Cooper", address: "0xndhfhdf...kjueu", avatar: "/placeholder.svg?height=40&width=40" },
    { name: "Jerome Bell", address: "0xndhfhdf...kjueu", avatar: "/placeholder.svg?height=40&width=40" },
    { name: "Marvin McKinney", address: "0xndhfhdf...kjueu", avatar: "/placeholder.svg?height=40&width=40" },
    { name: "Kathryn Murphy", address: "0xndhfhdf...kjueu", avatar: "/placeholder.svg?height=40&width=40" },
    { name: "Ralph Edwards", address: "0xndhfhdf...kjueu", avatar: "/placeholder.svg?height=40&width=40" },
  ]
            ...
            <div className="space-y-6">
              <div className="text-center space-y-4">
                ...
                <div className="flex items-center justify-center gap-2">
                  <div className="text-white text-4xl font-light min-w-[200px] text-center">{amount || "|"}</div>
                </div>
              ...
              <div className="mt-8">
                <div className="text-white/70 text-sm mb-3">Available Balance</div>
    ...
    return (
      <div className="fixed inset-0 bg-gradient-to-b from-[#0a0e27] via-[#1a1f3a] to-[#0a0e27] z-50 overflow-y-auto">
        <div className="max-w-md mx-auto min-h-screen pb-6">
          <div className="px-4 pt-6">
            <div className="flex items-center justify-between mb-8">
              <Button variant="ghost" className="text-white hover:bg-white/10 p-2" onClick={() => setStep("amount")}>
                <ArrowLeft className="w-5 h-5 mr-2" />
                Back
              </Button>
              <h1
                  ...
                  {contacts.map((contact, idx) => (
                    ...
                    >
                      ...
                      <div className="text-left">
                        ...
                        <div className="text-white/50 text-sm">{contact.address}</div>
                      </div>
                    </button>
                  ))}
                </div>
