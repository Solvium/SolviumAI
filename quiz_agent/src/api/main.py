...
def set_bot_instance(bot):
    ...
    bot_instance = bot
    logger.info(
        "Bot instance set in FastAPI application with performance optimizations"
    )
...
def get_http_client() -> Optional[httpx.AsyncClient]:
    """Get the global HTTP client for external requests."""
    return http_client


def get_app_cache() -> Dict[str, Any]:
...
if FASTAPI_AVAILABLE:
    ...
    async def get_performance_metrics():
        ...
        try:
            ...
            return await performance_service.get_performance_summary(hours=1)
        except Exception as e:
    ...
    async def get_cache_metrics():
        ...
        try:
            ...
            return {
                "cache_stats": performance_service.cache_stats,
                "redis_info": await RedisClient.get_instance() is not None,
            }
        except Exception as e:
    ...
    async def optimize_performance():
        ...
        try:
            ...
            # Clean up inactive user cache
            await optimized_user_service.cleanup_inactive_cache(days=7)

            # Flush bulk operations
            from services.performance_service import bulk_manager
