...
def create_quiz_creation_keyboard() -> ReplyKeyboardMarkup:
    ...
    return ReplyKeyboardMarkup(
        [
            [KeyboardButton("📝 Quick Quiz"), KeyboardButton("⚙️ Custom Quiz")],
            [KeyboardButton("📊 Quiz Templates"), KeyboardButton("📈 My Quizzes")],
...
def create_quiz_templates_keyboard() -> ReplyKeyboardMarkup:
    ...
    return ReplyKeyboardMarkup(
        [
            ...
            [KeyboardButton("📚 History"), KeyboardButton("⚽ Sports")],
            [KeyboardButton("🎬 Entertainment"), KeyboardButton("🌍 Geography")],
...
def create_quiz_settings_keyboard() -> ReplyKeyboardMarkup:
    ...
    return ReplyKeyboardMarkup(
        [
            [KeyboardButton("⏱️ Set Duration"), KeyboardButton("💰 Set Rewards")],
            [KeyboardButton("👥 Public Quiz"), KeyboardButton("🔒 Private Quiz")],
            [KeyboardButton("✅ Create Quiz"), KeyboardButton("❌ Cancel")],
        ],
        resize_keyboard=True,
        one_time_keyboard=False,
...
def create_quiz_play_keyboard() -> ReplyKeyboardMarkup:
    ...
    return ReplyKeyboardMarkup(
        [
            [KeyboardButton("🎯 Active Quizzes"), KeyboardButton("🏆 My Results")],
            [KeyboardButton("📊 Quiz History"), KeyboardButton("🎖️ Achievements")],
            [KeyboardButton("⬅️ Back to Games")],
        ],
        resize_keyboard=True,
        one_time_keyboard=False,
...
def create_rewards_keyboard() -> ReplyKeyboardMarkup:
    ...
    return ReplyKeyboardMarkup(
        [
            [KeyboardButton("💳 Connect Wallet"), KeyboardButton("💰 View Balance")],
            [
...
def create_community_keyboard() -> ReplyKeyboardMarkup:
    ...
    return ReplyKeyboardMarkup(
        [
            [KeyboardButton("📢 Announcements"), KeyboardButton("💬 Discussion")],
            [KeyboardButton("🎮 Gaming Group"), KeyboardButton("📈 Trading Group")],
            [KeyboardButton("⬅️ Back to Main Menu")],
        ],
        resize_keyboard=True,
        one_time_keyboard=False,
...
def create_app_keyboard() -> ReplyKeyboardMarkup:
    ...
    return ReplyKeyboardMarkup(
        [
            [KeyboardButton("🌐 Open Web App"), KeyboardButton("📱 Download Mobile")],
            [KeyboardButton("💳 Connect Wallet"), KeyboardButton("💰 View Rewards")],
            [KeyboardButton("⬅️ Back to Main Menu")],
        ],
        resize_keyboard=True,
        one_time_keyboard=False,
...
def create_inline_main_menu_keyboard() -> InlineKeyboardMarkup:
    ...
    return InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton(
                    "🎯 Create Quiz", callback_data="menu:create_quiz"
                ),
                InlineKeyboardButton("🎲 Play Quiz", callback_data="menu:play_quiz"),
            ],
            [
                InlineKeyboardButton(
...
def create_inline_game_selection_keyboard() -> InlineKeyboardMarkup:
    ...
    return InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton(
                    "🎯 Create Quiz", callback_data="game:create_quiz"
                ),
                InlineKeyboardButton("🎲 Play Quiz", callback_data="game:play_quiz"),
            ],
            [
                InlineKeyboardButton(
                    "🏆 Leaderboards", callback_data="game:leaderboards"
                ),
                InlineKeyboardButton("💰 My Rewards", callback_data="game:rewards"),
            ],
            [InlineKeyboardButton("🎯 My Points", callback_data="game:my_points")],
...
def create_inline_challenge_keyboard() -> InlineKeyboardMarkup:
    ...
    return InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton(
                    "👥 Challenge Group", callback_data="challenge:group"
                ),
                InlineKeyboardButton(
                    "👤 Challenge Friend", callback_data="challenge:friend"
                ),
            ],
            [
                InlineKeyboardButton(
                    "🏅 My Challenges", callback_data="challenge:my_challenges"
                ),
                InlineKeyboardButton(
                    "📊 Challenge Stats", callback_data="challenge:stats"
                ),
            ],
            [InlineKeyboardButton("⬅️ Back to Main Menu", callback_data="menu:main")],
        ]
...
def create_inline_community_keyboard() -> InlineKeyboardMarkup:
    ...
    return InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton(
                    "📢 Join Announcements", url="https://t.me/solvium_announcements"
                ),
                InlineKeyboardButton(
                    "💬 Join Discussion", url="https://t.me/solvium_community"
                ),
            ],
            [
                InlineKeyboardButton(
                    "🎮 Join Gaming", url="https://t.me/solvium_gaming"
                ),
                InlineKeyboardButton(
                    "📈 Join Trading", url="https://t.me/solvium_trading"
                ),
            ],
            [InlineKeyboardButton("⬅️ Back to Main Menu", callback_data="menu:main")],
        ]
...
def create_inline_app_keyboard() -> InlineKeyboardMarkup:
    ...
    return InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton(
                    "🌐 Open Web App", web_app={"url": "https://solvium.ai"}
                ),
                InlineKeyboardButton(
                    "📱 Download Mobile",
            ...
            [
                InlineKeyboardButton(
                    "💳 Connect Wallet", callback_data="app:connect_wallet"
                ),
                InlineKeyboardButton("💰 View Rewards", callback_data="app:rewards"),
            ],
            [InlineKeyboardButton("⬅️ Back to Main Menu", callback_data="menu:main")],
        ]
    )
...
def create_inline_quiz_creation_keyboard() -> InlineKeyboardMarkup:
    ...
    return InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton(
                    "📝 Quick Quiz", callback_data="quiz:quick_create"
                ),
                InlineKeyboardButton(
                    "⚙️ Custom Quiz", callback_data="quiz:custom_create"
                ),
            ],
            [
                InlineKeyboardButton(
                    "📊 Quiz Templates", callback_data="quiz:templates"
                ),
                InlineKeyboardButton("📈 My Quizzes", callback_data="quiz:my_quizzes"),
            ],
            [InlineKeyboardButton("⬅️ Back to Main Menu", callback_data="menu:main")],
        ]
    )
...
def create_inline_quiz_play_keyboard() -> InlineKeyboardMarkup:
    ...
    return InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton("🎯 Active Quizzes", callback_data="quiz:active"),
                InlineKeyboardButton("🏆 My Results", callback_data="quiz:results"),
            ],
            [
                InlineKeyboardButton("📊 Quiz History", callback_data="quiz:history"),
                InlineKeyboardButton(
                    "🎖️ Achievements", callback_data="quiz:achievements"
                ),
            ],
            [InlineKeyboardButton("⬅️ Back to Main Menu", callback_data="menu:main")],
        ]
