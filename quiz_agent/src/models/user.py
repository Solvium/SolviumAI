...
# Import UserWallet for relationship (will be imported later to avoid circular imports)
...
class User(Base):
    ...
    )  # Legacy field for manually linked wallets
    wallet_created = Column(
        Boolean, default=False, index=True
    )  # Track if auto-wallet was created
